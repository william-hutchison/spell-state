...
class Graphics:
    ...
    def __init__(self):
        ...
        self.surface_ui = pg.Surface((400, 800))
        self.scale = 0
    ...
    def update_window(self):
        ...
        self.surface_final.blit(self.surface_ui, (800, 0))
    ...
    def update_ui(self, state, camera, character, inspector_dict):

        self.surface_ui.fill((30, 40, 40))
        self.draw_time()
    ...
    def draw_terrain(self, camera_location, topology, resources):
        ...
        # draw contours aMOVE TO WITHIN TILE LOOP
        for y in range(glob.WORLD_SIZE[1]):
            for x in range(glob.WORLD_SIZE[0]):
    ...
    def draw_time(self):
        ...
        self.surface_ui.blit(text0, (10, 10))
    ...
    def draw_state_info(self, state):
        ...
        self.surface_ui.blit(text0, (10, 100))
        self.surface_ui.blit(text1, (10, 130))
        self.surface_ui.blit(text2, (10, 160))
    ...
    def draw_player_info(self, camera, character):
        ...
        self.surface_ui.blit(text0, (10, 300))
        self.surface_ui.blit(text1, (10, 330))
        self.surface_ui.blit(text2, (10, 360))
    ...
    def draw_inspector_info(self, inspector_dict):
        ...
        for item in inspector_dict.items():
            if item[1]:
                text = self.font.render(item[0]+": "+item[1], True, (255, 255, 255))
                self.surface_ui.blit(text, (10, 500+30*i))
                i += 1
