...
class Game:
    ...
    def play(self, events):
        ...
        self.player.update(self.world.map_topology, self.world.map_resource, self.world.map_item, self.world.map_entities, events, self.graphics_manager.create_transfer_interface)
        self.world.update()
